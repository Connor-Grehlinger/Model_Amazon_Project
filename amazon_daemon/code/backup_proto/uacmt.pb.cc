...
Purchase::Purchase(const Purchase& from)
  ...
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::memcpy(&whid_, &from.whid_,
    static_cast<size_t>(reinterpret_cast<char*>(&upsuserid_) -
    reinterpret_cast<char*>(&whid_)) + sizeof(upsuserid_));
...
void Purchase::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000020u) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(6, this->upsuserid(), output);
  }
...
::google::protobuf::uint8* Purchase::InternalSerializeWithCachedSizesToArray(
  ...
  // optional int64 upsuserid = 6 [default = -1];
  if (cached_has_bits & 0x00000020u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(6, this->upsuserid(), target);
  }
...
void Purchase::InternalSwap(Purchase* other) {
  ...
  swap(upsuserid_, other->upsuserid_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_cached_size_, other->_cached_size_);
}
