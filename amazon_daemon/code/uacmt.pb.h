...
class Purchase : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Purchase) */ {
 public:
  ...
  const ::std::string& upsuserid() const;
  void set_upsuserid(const ::std::string& value);
  #if LANG_CXX11
  void set_upsuserid(::std::string&& value);
  #endif
  void set_upsuserid(const char* value);
  void set_upsuserid(const char* value, size_t size);
  ::std::string* mutable_upsuserid();
  ::std::string* release_upsuserid();
  void set_allocated_upsuserid(::std::string* upsuserid);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr upsuserid_;
  ::google::protobuf::int32 whid_;
...
inline void Purchase::clear_upsuserid() {
  upsuserid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_upsuserid();
}
inline const ::std::string& Purchase::upsuserid() const {
  // @@protoc_insertion_point(field_get:Purchase.upsuserid)
  return upsuserid_.GetNoArena();
}
inline void Purchase::set_upsuserid(const ::std::string& value) {
  set_has_upsuserid();
  upsuserid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:Purchase.upsuserid)
}
#if LANG_CXX11
inline void Purchase::set_upsuserid(::std::string&& value) {
  set_has_upsuserid();
  upsuserid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:Purchase.upsuserid)
}
#endif
inline void Purchase::set_upsuserid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_upsuserid();
  upsuserid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Purchase.upsuserid)
}
inline void Purchase::set_upsuserid(const char* value, size_t size) {
  set_has_upsuserid();
  upsuserid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Purchase.upsuserid)
}
inline ::std::string* Purchase::mutable_upsuserid() {
  set_has_upsuserid();
  // @@protoc_insertion_point(field_mutable:Purchase.upsuserid)
  return upsuserid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Purchase::release_upsuserid() {
  // @@protoc_insertion_point(field_release:Purchase.upsuserid)
  clear_has_upsuserid();
  return upsuserid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void Purchase::set_allocated_upsuserid(::std::string* upsuserid) {
  if (upsuserid != NULL) {
    set_has_upsuserid();
  } else {
    clear_has_upsuserid();
  }
  upsuserid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), upsuserid);
  // @@protoc_insertion_point(field_set_allocated:Purchase.upsuserid)
}
